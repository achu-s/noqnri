                          ...
                          <div class="col-md-5">
                              <div class="img-box">
                              	<?php if($part->logo!=NULL){?>
                                	<img src="<?php echo Common::backend_url().'/uploads/partner/'.$part->id."/logo/".$part->logo;?>" class="img-responsive">
                                <?php }else{?>
                            ...
                            <table class="star-table">
                             <tr>
                              ...
                              <script type="text/javascript">
                                ...
                                <tr>
                                  <?php if($part->phone_number!=NULL){?>
                                      <th>        
                                      <i class="fa fa-mobile" aria-hidden="true"></i>
                                      <?php echo $part->phone_number;?>
                                      </th>
                                  <?php }?>
                                </tr>
                           </table>
                           <?php 
                           $country_name = ($part->Country_details)?','.$part->Country_details->country_name:'';
                           $state_name = ($part->State_details)?','.$part->State_details->state_name:'';
                           $city_name = ($part->City_details)?','.$part->City_details->name:'';
                           ?>
