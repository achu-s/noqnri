<?php if($categoryDetails->category_banner!=NULL){?>
	<section class="header-hospitals-main" style="background-image: url('<?php echo Common::backend_url().'/uploads/category/banner/'.$categoryDetails->category_banner;?>');">
<?php }else{?>
            	...
            	<div class="col-md-9 well-c admin-content" id="home">
                    			...
                    			<?php if(empty($partnerPhotos)){?>
                    			    ...
                    			    <div class="carousel-inner">
                    			    	<div class="item active">
          									 <img src="<?php echo Yii::app()->baseurl."/vendor/images/1400x550.png"?>" alt="Default Image"> 
                                <div class="bottom-left">
                                  <div class="row">
                                    	<div class="col-md-3">
                                        <?php if($partnerDetail->phone_number!=NULL){?><p><i class="fa fa-mobile"></i> <?php echo $partnerDetail->phone_number;?></p><?php }?>
                                    	</div>
    											  	<div class="col-md-5">
    											  		<?php 
                                   $country_name = ($partnerDetail->phone_number->Country_details)?','.$partnerDetail->Country_details->country_name:'';
                                   $state_name = ($partnerDetail->State_details)?','.$partnerDetail->State_details->state_name:'';
                                   $city_name = ($partnerDetail->City_details)?','.$partnerDetail->City_details->name:'';
                                ?>
    													<p><i class="fa fa-map-marker"></i> <?php echo $partnerDetail->address.$Landmark.$country_name.$state_name.$city_name;?></p>
                    							  	</div>
    											  	<div class="col-md-4">
                                        ...
                                        ?>
          								...
          								<?php if(count($partnerPhotos)>1){?>
                                          	<a class="left carousel-control cus-co-left" href="#myCarousel" data-slide="prev">
                                                <img src="<?php echo Yii::app()->request->baseUrl; ?>/vendor/images/sliderleft.png">
                                                <span class="sr-only">Previous</span>
                                          	</a>
                                          	<a class="right carousel-control cus-co-right" href="#myCarousel" data-slide="next">
                                                <img src="<?php echo Yii::app()->request->baseUrl; ?>/vendor/images/sliderright.png">
                	...
                	<div id="Dynamic_Content">
                                    ...
                                    <div id="London" class="tabcontent">
                                    	...
                                    	<?php $i=0;foreach($reviewList as $review){?>
                                          	<div class="revi-inner-person">
                                                <div class="row">
                                                 <div class="col-md-2">
                                                   <img src="<?php echo Yii::app()->request->baseUrl; ?>/vendor/images/unknown-man.png">
                                                 </div> 
                                                 <div class="col-md-10">
                		...
                		<?php if(!empty($array_list)){?>
                        	...
                        	<script src="<?php echo Yii::app()->request->baseUrl; ?>/vendor/js/jquery.min.js"></script>
    						          <script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/vendor/js/jquery.star-rating-svg.js"></script>
...
<script src="<?php echo Yii::app()->request->baseUrl; ?>/vendor/js/jquery.min.js"></script>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/vendor/js/jquery.star-rating-svg.js"></script>
<script src="<?php echo Yii::app()->request->baseUrl; ?>/vendor/js/sweetalert2.all.min.js"></script>
<script type="text/javascript">
...
$("#wite_review").submit(function( event ) {
	  ...
	  $('#loading_img').show();
	  $('#Dynamic_Content').html('<img src="<?php echo Yii::app()->request->baseUrl;?>/vendor/images/Loader3.gif" alt="Loading">').css({'text-align':'center'});
