...
class Partner extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
		    ...
		    'Country_details'=>array(self::BELONGS_TO,'Category',array('country_id'=>'id')),
		    'State_details'=>array(self::BELONGS_TO,'Category',array('state_id'=>'id')),
		    'City_details'=>array(self::BELONGS_TO,'Category',array('city_id'=>'id')),
		);
	}
